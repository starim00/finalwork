...
public class FrmCustomerManager_Modify extends JDialog implements ActionListener {
	...
	public FrmCustomerManager_Modify(JDialog f, String s, boolean b, BeanCustomer bc) {
		super(f, s, b);
		this.bc = bc;
		...
		edtName.setText(bc.getCustomerName());
		edtAddress.setText(bc.getCustomerAddress());
		edtcon.setText(bc.getContactPerson());
