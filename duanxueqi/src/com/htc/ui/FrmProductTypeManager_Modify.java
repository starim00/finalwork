...
public class FrmProductTypeManager_Modify extends JDialog implements ActionListener {
	...
	public FrmProductTypeManager_Modify(JDialog f, String s, boolean b, BeanProductType bpt) {
		super(f, s, b);
